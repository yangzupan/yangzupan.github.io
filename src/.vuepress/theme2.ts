...
export default hopeTheme({
  ...
  displayFooter: true,
  // 页脚
  footer: '<div class="statement"> Copyright © 2023  <a href="/">老攀哥</a> All Rights Reserved.</div> <div class="record">  <div>Powered by <a href="https://v2.vuepress.vuejs.org/zh/" target="_blank">VuePress</a>&nbsp; | &nbsp;Theme by <a href="https://theme-hope.vuejs.press/zh" target="_blank">Hope</a></div></div>',
